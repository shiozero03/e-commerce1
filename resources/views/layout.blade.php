...
<body>
	<header class="fixed fixed-top">
		...
		<div class="bg-landinginfo text-landinglight header-search">
			<div class="container pt-1 pb-1">
				<div class="d-lg-flex d-md-flex align-items-center">
					<div class="float-start col-lg-2 col-md-2 col-12 d-lg-block d-md-block d-none text-center pb-2">
						@foreach($tentang as $ttg)
						<img src="{{ asset('mystyle/image/'.$ttg->logo) }}" width="70%">
						@endforeach
					</div>
					<div class="float-start col-lg-8 col-md-7 col-12 text-start pb-2">
						<form class="form-search-landing" action="/produk/search" method="post">
							@csrf
							<div class="form-group">
								<div class="input-group">
                  					<input type="search" class="form-control p-lg-2 p-md-2 p-1" name="search" placeholder="Apa yang anda cari hari ini ?" >
                  					<button class="btn btn-landingprimary"><i class="fas fa-search"></i></button>
                				</div>
							</div>
						</form>
					</div>
					<div class="clearfix d-lg-none d-md-none"></div>
					<hr class="pembatas mt-1 d-lg-none d-md-none mb-1">
					<div class="float-start col-lg-2 col-md-3 col-12 pb-2">
						@if($sessionget < 1)
						<div class="text-center">
							<a href="masuk" class="btn btn-landingprimary">Masuk</a>
							<a href="daftar" class="btn btn-landinglight">Daftar</a>
						</div>
						@else
							@foreach($userdata as $user)
							<div class="text-center">
								<a href="/profil" class="btn btn-landingprimary"><i class="fas fa-user-circle me-2"></i> {{$user->nama}}</a>
							</div>
							@endforeach
						@endif
					</div>
	...
	<div id="content" class="bg-landingcontent pb-5">
		@yield('main')
	</div>
